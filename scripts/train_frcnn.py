...
parser.add_option("--epoch_length", type="int",dest="epoch_length", help="Number of iterations per epoch.", default=1000) ## ADDED BY SIMO
...
if options.parser == 'pascal_voc':
	from sidelobe_finder.pascal_voc_parser import get_data
	...
	while True:
		try:
			...
			if iter_num == epoch_length:
				...
				# ===   ADDED BY SIMO
				# ==============================
				with open("nn_loss.dat", "a") as loss_file:
